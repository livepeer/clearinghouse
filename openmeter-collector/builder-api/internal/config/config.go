...
func Load() (Config, error) {
	cfg := Config{
		...
		OpenMeterDefaultPlanKey:   envOr("OPENMETER_DEFAULT_PLAN_KEY", "clearinghouse_demo_starter"),
		...
		IdentityWebhookURL:   firstEnv("REMOTE_SIGNER_WEBHOOK_URL", "IDENTITY_WEBHOOK_URL"),
