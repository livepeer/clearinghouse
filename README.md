...
**npm:** `@livepeer/clearinghouse-identity-webhook` is published from this directory (`./protocol`, `./verifiers`). Releases use tag `v*.*.*` and [trusted publishing](identity-webhook/docs/RELEASING.md).
